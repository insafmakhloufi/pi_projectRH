...
public class Dashboard_Front implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (pageContainer != null) {
            Nav.setDefaultContentArea(pageContainer);
            NavigationService.init(pageContainer);
        }
    ...
    private void handleEvenement() {
        ...
        loadPage("/views_event/event_affichage.fxml");
    ...
    private void loadPage(String fxmlFile) {
        ...
        try {
            ...
            URL resource;
            if (fxmlFile != null && fxmlFile.startsWith("/")) {
                resource = getClass().getResource(fxmlFile);
            } else {
                resource = getClass().getResource("/Dashboardfxml/" + fxmlFile);
            }
