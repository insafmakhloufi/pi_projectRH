...
public final class OfferDetailsDialog {
    ...
    public static void show(Window owner, OffreEmploi offre, String stylesheetResourcePath) {
        show(owner, offre, stylesheetResourcePath, true, null);
    }

    public static void show(Window owner, OffreEmploi offre, String stylesheetResourcePath, boolean countView) {
        show(owner, offre, stylesheetResourcePath, countView, null);
    }

    public static void show(Window owner, OffreEmploi offre, String stylesheetResourcePath, boolean countView, Runnable onViewCounted) {
        if (offre == null) {
            return;
        }
        ...
        if (countView) {
            ...
            // Notifier le callback si fourni (pour rafraîchir le dashboard)
            if (onViewCounted != null) {
                onViewCounted.run();
            }
        }
        ...
        // Bouton Postuler supprimé - fonctionnalité désactivée
        ...
        body.getChildren().addAll(translationBar, sp);
