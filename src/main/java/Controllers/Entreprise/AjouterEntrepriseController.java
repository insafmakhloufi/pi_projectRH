...
public class AjouterEntrepriseController {
    ...
    private void initialize() {
        ...
        if (tfNom != null) tfNom.textProperty().addListener((obs, o, n) -> { clearInlineError(tfNom, errNom); clearLogoError(); });
    ...
    private boolean validateEntrepriseFormAndShowErrors(String nom, String adresse, String ville, String telephone, String email, String description) {
        ...
        if (logoValue == null || logoValue.isBlank()) {
            showInlineError(null, errLogo, "Logo obligatoire - Veuillez choisir ou générer un logo");
            ok = false;
        }
