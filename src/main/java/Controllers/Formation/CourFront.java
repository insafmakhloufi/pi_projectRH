...
public class CourFront {
    ...
    private void showPrediction(Cour c) {
        ...
        String chaptersAnalysis = courseAnalyzer.getChaptersAnalysis(c);
        String learningTips = courseAnalyzer.getLearningTips(c);
        ...
        Label chapTitle = new Label("Analyse des chapitres");
        chapTitle.getStyleClass().add("dialog-title");
        TextArea chapArea = new TextArea(chaptersAnalysis);
        chapArea.setEditable(false);
        chapArea.setWrapText(true);
        chapArea.setPrefRowCount(10);

        Label tipsTitle = new Label("Conseils pour comprendre le cours");
        tipsTitle.getStyleClass().add("dialog-title");
        TextArea tipsArea = new TextArea(learningTips);
        tipsArea.setEditable(false);
        tipsArea.setWrapText(true);
        tipsArea.setPrefRowCount(8);

        VBox content = new VBox(10, predLabel, chapTitle, chapArea, tipsTitle, tipsArea);
