...
public class RH_CandidaturesController {
    ...
    private void initialize() {
        ...
        //jdiddddddddd
        List<Candidature> data;
        if (Session.getCurrentUser() != null
                && Session.getCurrentUser().getRole().equals("MANAGER_RH")) {
            data = candidatureService.afficherCandidaturesPourManagerRH(
                    Session.getCurrentUser().getId()
            );
        } else {
            data = candidatureService.afficherCandidatures();
        }
