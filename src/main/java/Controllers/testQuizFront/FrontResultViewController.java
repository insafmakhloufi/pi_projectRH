...
public class FrontResultViewController implements Initializable {
    ...
    private void handleExportPdf() {
        ...
        try {
            Class<?> clazz = Class.forName("Services.testQuiz.QuizPdfExportService");
            var method = clazz.getMethod("exportWithChooser", Utils.front.FrontQuizResult.class, javafx.stage.Window.class);
            method.invoke(null, result, owner);
        } catch (Exception e) {
