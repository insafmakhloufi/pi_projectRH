...
public class AjouterOffre implements Initializable {
    ...
    @FXML
    private ComboBox<String> niveauEtudesCombo;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // Initialiser le ComboBox des niveaux d'études
        if (niveauEtudesCombo != null) {
            niveauEtudesCombo.getItems().setAll(
                "Bac",
                "Bac+1",
                "Bac+2",
                "Bac+3 (Licence)",
        ...
        if (niveauEtudesCombo != null) {
            niveauEtudesCombo.valueProperty().addListener((obs, oldVal, newVal) -> clearError(niveauEtudesCombo, errNiveauEtudes));
        }
        if (languesRequisesField != null) {
    ...
    private void applyEditingIfNeeded() {
        ...
        if (niveauEtudesCombo != null) {
            niveauEtudesCombo.getSelectionModel().select(editingOffre.getNiveauEtudes());
        }
        if (languesRequisesField != null) {
    ...
    void resetForm(ActionEvent event) {
        ...
        clearError(niveauEtudesCombo, errNiveauEtudes);
        ...
        if (editingOffre != null) {
            ...
            if (niveauEtudesCombo != null) {
                niveauEtudesCombo.getSelectionModel().select(src.getNiveauEtudes());
            }
            if (languesRequisesField != null) {
    ...
    void ajouterOffre(ActionEvent event) {
        ...
        String niveauEtudes = niveauEtudesCombo != null ? niveauEtudesCombo.getValue() : null;
        ...
        if (niveauEtudes == null || niveauEtudes.isEmpty()) {
            showError(niveauEtudesCombo, errNiveauEtudes, "Niveau d'études obligatoire");
            valid = false;
        }
    ...
    private void clearForm() {
        ...
        if (niveauEtudesCombo != null) {
            niveauEtudesCombo.getSelectionModel().clearSelection();
        }
        if (languesRequisesField != null) {
