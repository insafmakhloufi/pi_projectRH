...
public class OpenAIService {
    ...
    public String obtenirReponse(String question) {
        try {
            ...
            // âœ… Parser correctement la rÃ©ponse JSON
            String json = response.toString();

            // Chercher "content" dans les choices
            int contentIndex = json.indexOf("\"content\":");
            if (contentIndex == -1) {
                return "Je suis dÃ©solÃ©, je ne peux pas rÃ©pondre pour le moment.";
            }

            // Avancer aprÃ¨s "content":
            ...
            // Chercher la fin du contenu (guillemet fermant non Ã©chappÃ©)
            ...
            return result.isEmpty()
                    ? "Je suis dÃ©solÃ©, je ne peux pas rÃ©pondre pour le moment."
                    : result;
