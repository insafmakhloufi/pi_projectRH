...
public class OpenAIService {
    ...
    public String chatCompletion(String systemPrompt, String userPrompt) throws Exception {
        ...
        if (cfg.apiKey == null || cfg.apiKey.isBlank()) {
            throw new IllegalStateException("openai.api_key est vide. Renseigne src/main/resources/config/openai.properties");
        }
    ...
    static class OpenAIConfig {
        ...
        static OpenAIConfig load() {
            ...
            String apiKeySys = System.getProperty("openai.api_key");
