...
public class OpenAILettreMotivationService {
    ...
    private static final String API_KEY = ""; // ← remplace ici
    private static final String API_URL = "";
    private static final String MODEL   = ""; // ou "gpt-3.5-turbo"

    /**
     * Génère une lettre de motivation via OpenAI GPT.
     */
    ...
    private String extractContent(String json) {
        ...
        try {
            ...
            if (start < 0) {
                ...
                return "Erreur: contenu introuvable dans la réponse";
            }
            start += marker.length();

            // Parcourt caractère par caractère pour gérer les échappements
    ...
    private String toJsonString(String s) {
        // Transforme une String Java en valeur JSON correctement échappée
        return "\"" + s
                .replace("\\", "\\\\")
                .replace("\"", "\\\"")
                .replace("\n", "\\n")
