...
public class AdminDashboardController {
    ...
    public void showProfile() {
        setActivePage("Profile", profilePage);
        loadProfileFromSession();
    }
    ...
    private void setActivePage(String title, VBox active) {
        ...
        if (profilePage != null) {
            profilePage.setVisible(active == profilePage);
            profilePage.setManaged(active == profilePage);
        }
    }
    ...
    public void createUser() {
        ...
        form.add(emailBox, 0, 1);
        form.add(phoneBox, 1, 1);
        form.add(passBox, 0, 2, 2, 1);
