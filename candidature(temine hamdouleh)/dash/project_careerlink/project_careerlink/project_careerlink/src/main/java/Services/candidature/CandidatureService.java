...
public class CandidatureService implements ICandidatureServices {
    ...
    public void ajouterCandidature(Candidature c) {
        ...
        String req = "INSERT INTO candidature " +
                ...
                "lettre_motivation, skills_text, Pieces_jointes, video_path, confirm_info, accept_privacy, decision_rh) " +
                "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public int ajouterCandidatureAndReturnId(Candidature c) {
        String sql = "INSERT INTO candidature " +
                "(user_id, prenom, nom, email, indicatif, tel, adresse, ville, date_naissance, " +
                "highest_degree, institution, lettre_motivation, skills_text, Pieces_jointes, video_path, confirm_info, accept_privacy, decision_rh) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
