...
public class AjouterCandidature {
    ...
    private void genererLettreIA() {
        ...
        // 4. Offre en dur (à remplacer plus tard par l'offre réelle)
        String nomOffre = "Développeur Full Stack Java/Spring Boot"; // ← tu changeras ça
        ...
        La lettre doit être formelle, convaincante, structurée en 3 paragraphes (introduction, 
        motivations & compétences, conclusion), et faire environ 250 mots.
        Réponds UNIQUEMENT avec la lettre, sans titre ni commentaire.
        """.formatted(
